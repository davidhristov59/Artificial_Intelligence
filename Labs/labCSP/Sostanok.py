...
def constraint_function(marija, simona, petar, meeting):
    ...
    if meeting not in simona_free_time or simona == 0:
        return False
    if meeting not in marija_free_time or marija == 1:
        return False
    if meeting not in petar_free_time or petar == 1:
        return False
...
if __name__ == '__main__':
    ...
    problem.addVariable("vreme_sostanok", [12, 13, 16, 17, 18, 19])
    # ----------------------------------------------------
    ...
    for solution in solutions:
        reordered_solutions = {"Simona_prisustvo": solution['Simona_prisustvo'],
                               "Marija_prisustvo": solution['Marija_prisustvo'],
                               "Petar_prisustvo": solution['Petar_prisustvo'],
                               "vreme_sostanok": solution['vreme-sostanok']
                               }
        print(reordered_solutions)
